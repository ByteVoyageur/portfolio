...
const Footer = () => {
  ...
  useEffect(() => {
    ...
    return () => {
      ;(themeInput as HTMLInputElement).removeEventListener(
        'change',
        toggleTheme
      )
    }
  ...
  useEffect(() => {
    ...
    document.querySelectorAll('.parallax-wrap').forEach((element) => {
      ...
      element.addEventListener('mouseleave', (e) => {
        ...
        gsap.to(Array.from(element.children), {
          duration: 0.3,
          scale: 1,
          x: 0,
          y: 0,
    ...
    const moveSectionElements = document.querySelectorAll(
      '.tp-mouse-move-element'
    )
              ...
              {footer_links.map((item, index) => (
                <div key={index} className='parallax-wrap'>
                  <div className='parallax-element'>
                    <Link className={item.cls} href={item.link}>
                      {item.icon}
                    </Link>
                  </div>
                </div>
            ...
            <div className='tp-hero-2__bottom-content d-flex justify-content-between'>
              ...
              <div className='tp-theme-toggle tp-theme-toggle-2 parallax-wrap'>
                <label
                  ...
                  className={`tp-theme-toggle-main themepure-theme-toggle parallax-element ${
                    active ? 'dark-active' : 'light-active'
                  }`}
                  htmlFor='this-s'
                >
                  <span
                    id='tp-theme-toggle-light'
                    className='tp-theme-toggle-light'
                  >
                    <svg
                      width='16'
                      height='16'
                  ...
                  <span
                    id='tp-theme-toggle-dark'
                    className='tp-theme-toggle-dark'
                  >
                    <svg
                      width='12'
                      height='12'
